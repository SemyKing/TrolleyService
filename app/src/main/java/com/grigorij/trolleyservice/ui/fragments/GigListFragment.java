...
public class GigListFragment extends Fragment {
	...
	private boolean doNotifyAdapter = false;
	...
	private void launchGigActivity(Gig gig) {
		...
		if (gig != null) {
			intent.putExtra(StaticValues.GIG_ID, gig.getId());
		}
	...
	private static class GigArrayAdapter extends ArrayAdapter<Gig> {
		...
		private final List<Gig> gigList;
